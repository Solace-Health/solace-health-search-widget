...
const SearchWidget = () => {
  ...
  const { control, handleSubmit, setValue, register, setError, formState: { errors } } = methods;
          ...
          <Wrapper>
              <Controller
                ...
                render={({ field }) => {
                  ...
                  {...field} 
                />
                {errors.serviceType && <ErrorMessage>{errors.serviceType.message}</ErrorMessage>}
                </div>
                }}
              />
            <div>
              <LocationSearch onHandleSelect={onSelectLocation} register={register}  />
              {errors.location && <ErrorMessage>Please enter a valid city or zip</ErrorMessage>}
            </div>
            <Controller
              name="workType"
              control={control}
